...
const UpdatePage = () => {
    ...
    const handleUpdate = (event) => {
      ...
      const info ={ itemName, imageUrl, subcategoryName, processingTime, description, price, rating, customization, stockStatus};
    ...
    return (
        <div>
          <div className="max-w-4xl mx-auto p-5">
            <h2 className="text-2xl font-bold mb-6 text-center">Update Craft Item:{product.itemName}</h2>
